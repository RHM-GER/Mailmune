...
- [ ] Hinweis: „KI Umschalten fehlgeschlagen“/„400 unknown field“ kamen vom ALTEN Agent-Binary bei laufender App – `tauri dev` komplett neu starten (prepare:sidecar baut den Agenten nur beim Start)
